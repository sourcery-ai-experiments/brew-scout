...
def main(database_dsn: str, sentry_dsn: str, telegram_api_url: str, telegram_api_token: str) -> None:
...
if __name__ == "__main__":
    ...
    main(args.database_dsn, args.sentry_dsn, args.telegram_api_url, args.telegram_api_token)
